...
\title{Aplikácia gamifikácie\\ pri zlepšovaní \\interakčných schopností detí s autizmom}
...
\begin{frame}[fragile=singleslide]\frametitle{Autizmus}
\begin{itemize}
...
\begin{frame}[fragile=singleslide]\frametitle{Gamifikácia}
\begin{itemize}
\item Nejaký text
...
\begin{frame}[fragile=singleslide]\frametitle{Gamifikácia v autizme}
\includegraphics[scale=.35]{gamification_process.png}
